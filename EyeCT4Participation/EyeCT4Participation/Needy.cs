...
namespace EyeCT4Participation
{
    class Needy : Account
    {
        ...
        public Needy(bool ov,string username, string password, string name, string adress, string residence, string email, int phonenumber, DateTime birthdate, string geslacht, bool active) : base(username, password, name, adress, residence, email, phonenumber, birthdate, active, geslacht)
        {
            this.Ov = ov;
        }
