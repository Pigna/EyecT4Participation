...
namespace EyeCT4Participation.Database
{
    ...
    {
        public bool DoQueryAddVolunteer(string gebruikersnaam, string wachtwoord, string naam, string adres, string postcode, string woonplaats, string geboortedatum, int telefoonnummer, int type, int geslacht) // replace user with the data u want to add/ change to the table
        {
            try
            {
